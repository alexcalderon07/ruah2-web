...
class GoogleAnalytics extends CommunityEnhancementsAbstract
{
	...
	public function edit() : void
	{
		...
		$form->add( new YesNo( 'ga_enabled', Settings::i()->ga_enabled, FALSE, array(), $validation ) );
		$form->add( new Codemirror( 'ga_code', Settings::i()->ga_code, FALSE, array( 'height' => 150, 'codeModeAllowedLanguages' => [ 'xml' ] ), NULL, NULL, NULL, 'ga_code' ) );
