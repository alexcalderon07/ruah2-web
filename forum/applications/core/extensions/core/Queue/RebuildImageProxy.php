...
class RebuildImageProxy extends QueueAbstract
{
	...
	public function run( mixed &$data, int $offset ): int
	{
		...
		foreach( $iterator as $item )
		{
			...
			if( mb_strpos( $item->$contentColumn, 'imageproxy.php' ) AND $newContent = Parser::removeImageProxy( $item->$contentColumn, !$data['cachePeriod'] ) AND $newContent != $item->$contentColumn )
			{
