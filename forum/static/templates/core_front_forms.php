...
$return .= <<<IPSCONTENT
		...
		<div class='cGuestTeaser i-margin-bottom_3'>
...
$return .= <<<IPSCONTENT
						...
						<button type="button" class='ipsButton ipsButton--primary ipsButton--small' data-action='writeReview'><i class="fa-regular fa-pen-to-square"></i><span>
IPSCONTENT;
