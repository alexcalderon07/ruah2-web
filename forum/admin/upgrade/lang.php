...
<div style="text-align: left">We are currently in the process of migrating our platform from PHP7 to PHP8 in order to provide you with the greatest level of performance and security. We've identified and disabled one or more Applications currently installed on your site which contain PHP8 incompatible code. Refer to the AdminCP &gt; Support &gt; Get Support page for more information.<br><br>You can re-enable these Applications via the AdminCP &gt; Applications page. Please make a note of the following Applications so you are clear which have been automatically disabled via the upgrader.</div>
TEXT,
