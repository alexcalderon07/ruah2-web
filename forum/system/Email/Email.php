...
abstract class Email
{
	...
	{
		if( defined( '\IPS\EMAIL_DEBUG_PATH' ) AND EMAIL_DEBUG_PATH)
		{
			return 'IPS\Email\Outgoing\Debug';
		}
		elseif ( Settings::i()->sendgrid_api_key and ( Settings::i()->mail_method === 'sendgrid' or ( Settings::i()->sendgrid_use_for == 2 ) or ( Settings::i()->sendgrid_use_for and $type === static::TYPE_BULK ) ) )
		{
			return 'IPS\Email\Outgoing\SendGrid';
		}
		elseif ( Settings::i()->mail_method === 'smtp' )
		{
        ...
        {
            if ( IN_DEV AND defined( 'DISABLE_CLOUD_EMAIL_LOCALHOST' ) AND \DISABLE_CLOUD_EMAIL_LOCALHOST )
            {
                return 'IPS\Email\Outgoing\Php';
            }
		    else
		    {
                return static::CLOUD_EMAIL_CLASS;
            }
        }
		else
		{
