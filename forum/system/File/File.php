...
abstract class File
{
	...
	public function duplicate() : File
	{
		...
		$return = static::create( $this->storageExtension, $this->originalFilename, $this->contents(), $this->container, $this instanceof FileSystem ? ( $this->configuration['dir'] . '/' . ( $this->container ? "{$this->container}/" : '' ) . $this->filename ) : true );
