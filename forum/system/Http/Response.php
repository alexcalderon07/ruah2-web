...
class Response
{
	 ...
	 */
	public mixed $httpResponseVersion = NULL;
	
	/**
	 * @brief	HTTP Response Code
	 */
	public mixed $httpResponseCode = NULL;
	
	/**
	 * @brief	HTTP Response Text
	 */
	public mixed $httpResponseText = NULL;
	 ...
	 */
	public function decodeChunked( string $body ): string
	{
		$response	= '';
		$initial	= $body;
	 ...
	 *	@li			BAD_JSON
	 */
	public function decodeJson( bool $asArray=TRUE ): mixed
	{
	 ...
	 *	@li			BAD_XML
	 */
	public function decodeXml(): SimpleXML
	{
		try
		{
			$xml = SimpleXML::loadString( $this->content );
		}
	 ...
	 * Decode Query String
	 *
	 * @param string|null $expectedKey	If provided, the return value will check for an element with this key and if it isn't present, throw an Exception
	 * @return	array
	 * @throws	RuntimeException
	 *	@li			EXPECTED_KEY_NOT_PRESENT
	 */
	public function decodeQueryString( string $expectedKey=NULL ): array
	{
