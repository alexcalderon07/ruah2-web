...
<div class="list-group">
	...
	<a href="<?php print $site_url; ?>admin/vote4coins" class="list-group-item list-group-item-action">
		<h5 class="list-group-item-heading"><i class="fa fa-thumbs-o-up fa-1" aria-hidden="true"></i> Vote4Bonus</h5>
	...
	<?php } if($web_admin>=$jsondataPrivileges['promoters']) { ?>
	<a href="<?php print $site_url; ?>admin/promoters" class="list-group-item list-group-item-action">
		<h5 class="list-group-item-heading"><i class="fa fa-barcode fa-1" aria-hidden="true"></i> Promoters </h5>
		<p class="list-group-item-text">See Promoters List</p>
	</a>
	<?php }if($web_admin>=$jsondataPrivileges['promoter_info']) { ?>
	<a href="<?php print $site_url; ?>admin/promoter_info" class="list-group-item list-group-item-action">
		<h5 class="list-group-item-heading"><i class="fa fa-barcode fa-1" aria-hidden="true"></i> Promoter Stats </h5>
		<p class="list-group-item-text">See Promoter Stats</p>
	</a>
	<?php } ?>
</div>
