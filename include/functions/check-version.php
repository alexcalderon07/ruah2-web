...
<?php
	...
	} else 
	{
		...
		if($helloworld)
			print '<div class="alert alert-info" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>'.$helloworld.'</div>';
		else if(!$lastVersion)
